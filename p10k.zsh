# Generated by Powerlevel10k configuration wizard on 2020-03-10 at 01:22 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 13496.
# Wizard options: nerdfont-complete + powerline, small icons, lean_8colors, time,
# 2 lines, disconnected, compact, concise, instant_prompt=verbose.
