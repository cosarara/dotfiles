...
syn keyword pkscommand	jump goto call end return jumpif callif
syn keyword pksConditional	if
syn keyword pksConditional	else
syn keyword pksLoop		while

syn match pksOperator      	"[=<>!]="
syn match pksOperator      	"[=<>!]"
syn match pksString		"^= .*$"
syn match pksPrepro		"^#define .\+$"
syn match pksPrepro		"^#include .\+$"
syn match pksPrepro		"^#dyn .\+$"
syn match pksPrepro		"^#dynamic .\+$"
syn match pksPrepro		"^#org .\+$"
syn match pksPrepro		"#raw .\+$"
