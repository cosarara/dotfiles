" mnml Airline - A Material Color Scheme based on Minimalist
" (this is Minimalist with a couple changes)
"
...
function! airline#themes#{s:theme}#refresh()
    if &background == "dark"
        ...
        " Normal
        let N1 = [ 'gray20', 'gray60', 233, 246 ]
        let N2 = [ 'gray30', 'gray70', 235, 249 ]
        let N3 = [ 'gray20', 'gray80', 233, 251 ]

        " Inactive
        let IA = [ 'gray15', N3[1], 235, N3[3] ]
